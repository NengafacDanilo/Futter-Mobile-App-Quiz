  ...
  Widget build(BuildContext context) {
    return AnimatedSplashScreen(
      splash: Column(
        children: [
          Center(
            child: LottieBuilder.asset('assets/Lottie/Animation - 1718179294311 (1).json'), // Corrected path
          ),
        ],
      ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Text(
                      'Quiz',
                      style: TextStyle(
                        color: Color.fromARGB(255, 57, 149, 235),
                     ...
                     print(newCurrent);
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          onPressed: (){
                            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>const MySearchPage()));          
                                            },
                          child: const Icon(
                            Icons.navigate_next,
                            size: 40,
